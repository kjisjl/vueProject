...
export default defineComponent({
  ...
  watch: {
    "$route.query": {
      handler() {
        this.$store.dispatch('product/postSearchProductAsync', this.$route.query)
      },
      immediate: true
    }
  },
  beforeDestroy() {
    //在组件销毁前发送清空clearKeyword，这样跳到其他页面搜索框里就不会有字了
      ...
      <div class="py-container">
        ...
        <div class="details clearfix">
          ...
          <div class="goods-list">
            <ul class="yui3-g" v-if="searchProductResult.goodsList.length>0">
              <li class="yui3-u-1-5" v-for="item in searchProductResult.goodsList" :key="item.id">
                <div class="list-wrap">
                  <div class="p-img">
                    <a href="#"><img :src="item.defaultImg"/></a>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
                  ...
                  <div class="attr">
                    <a target="_blank" href="item.html"
                       :title="item.title" v-html="item.title"></a>
                  </div>
                  <div class="commit">
